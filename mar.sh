...
#Install Subs
wget -N -P /var/lib/marzban/templates/subscription/  https://raw.githubusercontent.com/Hermananza/sc/main/index.html

#install env
wget -O /opt/marzban/.env "https://raw.githubusercontent.com/Hermananza/sc/main/env"
...
wget -O /usr/bin/profile "https://raw.githubusercontent.com/Hermananza/sc/main/profile";
chmod +x /usr/bin/profile
apt install neofetch -y
wget -O /usr/bin/cekservice "https://raw.githubusercontent.com/Hermananza/sc/main/cekservice.sh"
chmod +x /usr/bin/cekservice

#install compose
wget -O /opt/marzban/docker-compose.yml "https://raw.githubusercontent.com/Hermananza/sc/main/docker-compose.yml"

#Install VNSTAT
apt -y install vnstat
/etc/init.d/vnstat restart
apt -y install libsqlite3-dev
wget https://github.com/Hermananza/sc/raw/main/vnstat-2.6.tar.gz
...
wget -O /opt/marzban/nginx.conf "https://raw.githubusercontent.com/Hermananza/sc/main/nginx.conf"
wget -O /opt/marzban/default.conf "https://raw.githubusercontent.com/Hermananza/sc/main/vps.conf"
wget -O /opt/marzban/xray.conf "https://raw.githubusercontent.com/Hermananza/sc/main/xray.conf"
...
wget -O /var/lib/marzban/xray_config.json "https://raw.githubusercontent.com/Hermananza/sc/main/xray_config.json"
...
#install database
wget -O /var/lib/marzban/db.sqlite3 "https://github.com/Hermananza/sc/raw/main/db.sqlite3"
